...
//		cache[cache_id].answer->shuffle();
		...
		const char *cached_answer_str = cached_answer.c_str();
		sdprintf("egg_dns_lookup(%s, %d): Found in cache -> %s", host, timeout, cached_answer_str);
...
//		cache[cache_id].answer->shuffle();
		const bd::String cached_answer(cache[cache_id].answer->join(','));
		const char *cached_answer_str = cached_answer.c_str();
		sdprintf("dns_lookup_block(%s, %d): Found in cache -> %s", host, timeout, cached_answer_str);
...
//		cache[cache_id].answer->shuffle();
		const bd::String cached_answer(cache[cache_id].answer->join(','));
		const char *cached_answer_str = cached_answer.c_str();
		sdprintf("dns_reverse_block(%s, %d): Found in cache -> %s", ip, timeout, cached_answer_str);
		return *(cache[cache_id].answer);
	}
...
//		cache[cache_id].answer->shuffle();
		const bd::String cached_answer(cache[cache_id].answer->join(','));
		const char *cached_answer_str = cached_answer.c_str();
		sdprintf("egg_dns_reverse(%s, %d): Found in cache -> %s", ip, timeout, cached_answer_str);
